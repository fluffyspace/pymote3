...
# Form implementation generated from reading ui file 'E:\Damir\FER\Postdiplomski\Doktorat\Istrazivanje\pymote3\pymote3\gui\simulation.ui'
#
...
class Ui_SimulationWindow(object):
    def setupUi(self, SimulationWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/pymote3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, SimulationWindow):
        SimulationWindow.setWindowTitle(QtGui.QApplication.translate("SimulationWindow", "Pymote3 Simulation", None, QtGui.QApplication.UnicodeUTF8))
